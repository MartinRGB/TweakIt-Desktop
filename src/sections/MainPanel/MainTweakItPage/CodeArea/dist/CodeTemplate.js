...
var SpringFactorEvaluator_1 = require("./SpringFactorEvaluator");
var CodeTemplate = react_1.memo(function (_a) {
    var name = _a.name, isExpanded = _a.isExpanded, style = _a.style;
    ...
    var AndroidSpringAnimationComponents = function () {
        ...
        console.log(new SpringFactorEvaluator_1["default"](cIF(mSolver['stiffness']), cIF(mSolver['dampingratio']), cIF(mSolver['damping']), cIF(mSolver['duration']), 0, 1).factor);
        return (react_1["default"].createElement(CodeDiv, null,
            ...
            react_1["default"].createElement(Class, null, "CustomSpringInterpolator"),
            "(",
            react_1["default"].createElement(Number, null, "wip"),
            ");",
            react_1["default"].createElement(Break, null),
            ...
            react_1["default"].createElement(Break, null),
            "animator.setDamping(",
            react_1["default"].createElement(Number, null, cIF(mSolver['damping'])),
            ");",
            react_1["default"].createElement(Break, null),
            "animator.setMass(",
