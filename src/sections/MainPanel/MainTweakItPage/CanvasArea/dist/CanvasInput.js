...
var CanvasInput = function (_a) {
    ...
    return (react_1["default"].createElement("div", null, (currentAnimName != 'HorizontalLine') ? (isBezierCalculator ?
        ...
        :
            react_1["default"].createElement(InputTree_1["default"], { name: 'property', index: 0, isLast: true, defaultVal: 0.5, isEditable: false, min: 0, max: 1, key: 'input_placeholder' })));
};
