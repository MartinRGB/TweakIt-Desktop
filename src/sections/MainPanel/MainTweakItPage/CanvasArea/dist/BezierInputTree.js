...
var BezierInputTree = react_1.memo(function (_a) {
    var style = _a.style, isLast = _a.isLast, isEditable = _a.isEditable, index = _a.index, name = _a.name, defaultVal = _a.defaultVal, svgHeight = _a.svgHeight, svgWidth = _a.svgWidth, svgScale = _a.svgScale, svgStrokeWidth = _a.svgStrokeWidth, viewBoxWFixed = _a.viewBoxWFixed, isBezier = _a.isBezier, viewBoxHFixed = _a.viewBoxHFixed;
    ...
    var _c = react_1.useContext(GraphUpdateContext_1.GraphUpdateContext), setBezierTriggeredIndex = _c.setBezierTriggeredIndex, bezierTriggeredIndex = _c.bezierTriggeredIndex, triggredIndex = _c.triggredIndex, setTriggeredIndex = _c.setTriggeredIndex, setGraphShouldUpdate = _c.setGraphShouldUpdate, shouldGraphupdate = _c.shouldGraphupdate;
    ...
    var _e = react_1.useState(currentSolverData[0]), prev1 = _e[0], setPrev1 = _e[1];
    var _f = react_1.useState(currentSolverData[0]), target1 = _f[0], setTarget1 = _f[1];
    var _g = react_1.useState(false), isStart1 = _g[0], setStart1 = _g[1];
    var _h = react_1.useState(currentSolverData[1]), prev2 = _h[0], setPrev2 = _h[1];
    var _j = react_1.useState(currentSolverData[1]), target2 = _j[0], setTarget2 = _j[1];
    var _k = react_1.useState(false), isStart2 = _k[0], setStart2 = _k[1];
    var _l = react_1.useState(currentSolverData[2]), prev3 = _l[0], setPrev3 = _l[1];
    var _m = react_1.useState(currentSolverData[2]), target3 = _m[0], setTarget3 = _m[1];
    var _o = react_1.useState(false), isStart3 = _o[0], setStart3 = _o[1];
    var _p = react_1.useState(currentSolverData[3]), prev4 = _p[0], setPrev4 = _p[1];
    var _q = react_1.useState(currentSolverData[3]), target4 = _q[0], setTarget4 = _q[1];
    ...
    var progress1 = react_spring_1.useSpring({
        ...
        onFrame: function () {
            ...
            if (bezierTriggeredIndex != -1)
                setCurrentSolverDataByIndex(value, 0);
    ...
    var progress2 = react_spring_1.useSpring({
        ...
        onFrame: function () {
            ...
            if (bezierTriggeredIndex != -1)
                setCurrentSolverDataByIndex(value, 1);
        },
        onRest: function () {
            setPrev2(target2);
            setStart2(false);
    ...
    var progress3 = react_spring_1.useSpring({
        ...
        onFrame: function () {
            ...
            if (triggredIndex != -1)
                setCurrentSolverDataByIndex(value, 2);
        },
        onRest: function () {
            setPrev3(target3);
            setStart3(false);
    ...
    var progress4 = react_spring_1.useSpring({
        ...
        onFrame: function () {
            ...
            if (bezierTriggeredIndex != -1)
                setCurrentSolverDataByIndex(value, 3);
        },
        onRest: function () {
            setPrev4(target4);
            setStart4(false);
    ...
    var p1 = Number(textValue.toString().split(",")[0]);
    var p2 = Number(textValue.toString().split(",")[1]);
    var p3 = Number(textValue.toString().split(",")[2]);
    var p4 = Number(textValue.toString().split(",")[3]);
    var handleDragLeft = function (e, ui) {
        ...
        setTextValue(p1V.toFixed(2) + "," + p2V.toFixed(2) + "," + currentSolverData[2].toFixed(2) + "," + currentSolverData[3].toFixed(2));
    };
    var handleDragRight = function (e, ui) {
        ...
        setStartAnimation(false);
        setGraphShouldUpdate(!shouldGraphupdate);
        setTextValue(currentSolverData[0].toFixed(2) + "," + currentSolverData[1].toFixed(2) + "," + p3V.toFixed(2) + "," + p4V.toFixed(2));
    };
    return (react_1["default"].createElement("div", null,
        react_1["default"].createElement(CustomSVG, { canShow: !selectTransition, width: boxWidth + boxPadding, height: boxHeight + boxPadding },
            react_1["default"].createElement("g", null,
                react_1["default"].createElement(CustomBorderline, { isEditable: isEditable, x1: boxPadding / 2, y1: boxPadding / 2, x2: boxWidth * currentSolverData[0] * transitionScale + boxPadding / 2, y2: boxHeight * currentSolverData[1] * transitionScale + boxPadding / 2, strokeWidth: svgStrokeWidth / 2 }),
                react_1["default"].createElement(CustomBorderline, { isEditable: isEditable, x1: boxWidth * (1 - transitionScale) + boxWidth * currentSolverData[2] * transitionScale + boxPadding / 2, y1: boxHeight * (1 - transitionScale) + boxHeight * currentSolverData[3] * transitionScale + boxPadding / 2, x2: boxWidth + boxPadding / 2, y2: boxHeight + boxPadding / 2, strokeWidth: svgStrokeWidth / 2 }))),
        isEditable ? react_1["default"].createElement(DraggableContainer, { canShow: !selectTransition, style: {
                width: boxWidth + "px",
                height: boxHeight + "px",
                transform: "translate3d(-50%,-50%,0) scale3d(1,1,1)"
            } },
            react_1["default"].createElement(react_draggable_1["default"], { axis: "both", handle: ".handle", position: { x: boxWidth * currentSolverData[0], y: boxHeight - boxHeight * currentSolverData[1] * 1. }, 
                ...
                scale: 1, bounds: { top: 0, left: 0, right: boxWidth, bottom: boxHeight }, 
                // position={null}
            ...
            react_1["default"].createElement(react_draggable_1["default"], { axis: "both", handle: ".handle", position: { x: boxWidth * currentSolverData[2], y: boxHeight * (1 - currentSolverData[3]) }, 
                // position={{x:isDragInit?(boxWidth*currentSolverData[0]*transitionScale):null,y:isDragInit?(boxHeight - boxHeight*currentSolverData[1]*transitionScale):null}}
                scale: 1, bounds: { top: 0, left: 0, right: boxWidth, bottom: boxHeight }, 
                // position={null}
...
var CustomBorderline = styled_1["default"].line(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  position: relative;\n  stroke-linecap:round;\n  stroke-linejoin:round;\n  stroke:", ";\n"], ["\n  position: relative;\n  stroke-linecap:round;\n  stroke-linejoin:round;\n  stroke:", ";\n"])), function (p) { return p.isEditable ? p.theme.colors.range_input_thumb : p.theme.colors.range_input_thumb_unactive; });
