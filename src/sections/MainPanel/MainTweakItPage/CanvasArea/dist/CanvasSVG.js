...
var SVGBlurContainer_1 = require("@Components/SVG/SVGBlurContainer");
var CanvasSVG = function (_a) {
    ...
    var isDoubleBezierCalculator = (currentAnimCalculator === 'DoubleCubicBezierCalculator');
    ...
    return (react_1["default"].createElement(Container, { isLayoutRow: isLayoutRow, svgHeight: svgHeight, style: {
        ...
        react_1["default"].createElement(SVGBlurContainer_1["default"], { svgWidth: svgWidth, svgHeight: svgHeight })));
};
