...
var ListTree = react_1.memo(function (_a) {
    var clickable = _a.clickable, platform = _a.platform, children = _a.children, name = _a.name, style = _a.style, _b = _a.defaultOpen, defaultOpen = _b === void 0 ? false : _b, info = _a.info, isUlElement = _a.isUlElement, index = _a.index, animation_data = _a.animation_data, calculator = _a.calculator, visible = _a.visible;
        ...
        children ?
            react_1["default"].createElement("div", { css: Toggle, onClick: function () { return setOpen(!isOpen); } },
                ...
                react_1["default"].createElement(UlTitle, { style: style },
                    react_1["default"].createElement(react_i18next_1.Trans, null, platform))) :
            react_1["default"].createElement("div", null, !visible ?
                react_1["default"].createElement("div", { css: core_1.css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["height:3px"], ["height:3px"]))) }) :
                react_1["default"].createElement(LiTitle, { style: __assign({}, style), isClickable: clickable, isSelected: currentAnimationItem === info, onClick: function () {
...
var LiTitle = styled_1["default"].span(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  vertical-align: middle;\n  user-select:none;\n  font-family: ", ";\n  font-style: normal;\n  font-weight: 300;\n  font-size: 10px;\n  line-height: 11px;\n  margin-left: 25px;\n  color:", ";\n  opacity:", ";\n  cursor:", ";\n"], ["\n  vertical-align: middle;\n  user-select:none;\n  font-family: ", ";\n  font-style: normal;\n  font-weight: 300;\n  font-size: 10px;\n  line-height: 11px;\n  margin-left: 25px;\n  color:", ";\n  opacity:", ";\n  cursor:", ";\n"])), function (props) { return props.theme.fonts.normalText; }, function (p) { return (p.isSelected ? p.theme.colors.primary : p.theme.colors.text); }, function (p) { return (p.isClickable ? '0.8' : '0.4'); }, function (p) { return (p.isClickable ? 'pointer' : 'not-allowed'); });
