...
vec2 LTC_Uv( const in vec3 N, const in vec3 V, const in float roughness ) {
	...
	const float LUT_SIZE = 64.0; //64.
	const float LUT_SCALE = ( LUT_SIZE - 1.0 ) / LUT_SIZE;
	const float LUT_BIAS = 0.5 / LUT_SIZE; //0.5
...
// Start Texture Area Light (ShaderToy)
...
vec3 LTC_Evaluate_With_Texture( const in vec3 N, const in vec3 V, const in vec3 P, const in mat3 mInv, const in vec3 rectCoords[ 4 ], in sampler2D tex) {
...
// End Texture Area Light (ShaderToy)
