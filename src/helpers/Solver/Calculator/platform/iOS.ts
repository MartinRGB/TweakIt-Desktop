import {iOSUIViewSpring,iOSCASpring} from '@Helpers/Solver/Calculator/type/SpringAnimationExtend'
import {CubicBezier} from '@Helpers/Solver/Calculator/type/CubicBezierExtend'

class UIViewSpring extends iOSUIViewSpring{constructor(dampingratio?:number,velocity?:number,duration?:number) {super(dampingratio,velocity,duration);}}
