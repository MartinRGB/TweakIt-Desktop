...
var MainButtonNormal = react_1.memo(function (_a) {
    var style = _a.style, children = _a.children, onClick = _a.onClick, onMouseDown = _a.onMouseDown, onMouseUp = _a.onMouseUp;
    ...
    return (react_1["default"].createElement(react_spring_1.animated.div, __assign({ css: AnimatedContainerCSS }, bind(), { style: {
        ...
        react_1["default"].createElement(Button, { style: style, onClick: onClick, onMouseDown: onMouseDown, onMouseUp: onMouseUp }, children)));
});
