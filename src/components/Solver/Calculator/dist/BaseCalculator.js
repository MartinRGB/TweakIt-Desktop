...
var SpringAnimationCalculator = /** @class */ (function () {
    ...
    SpringAnimationCalculator.prototype.computeOverDampingTension = function (oldFriction, newDampingratio, mass) {
    ...
    SpringAnimationCalculator.prototype.computeDurationWithDampingRatio = function (tension, dampingRatio, mass, factor) {
        var epsilon = 0.001 / factor;
        var velocity = 0.0;
        var undampedFrequency = Math.sqrt(tension / mass);
        // Key Bug When dampingRatio > 1
        var a = Math.sqrt(Math.abs(1 - Math.pow(dampingRatio, 2)));
        var b = velocity / (a * undampedFrequency);
        var c = dampingRatio / a;
        var d = -((b - c) / epsilon);
        if (d <= 0) {
    ...
    SpringAnimationCalculator.prototype.getDuration = function () {
        return this.duration;
    };
...
var FlingAnimationCalculator = /** @class */ (function () {
    ...
    FlingAnimationCalculator.prototype.getDuration = function () {
        return this.duration;
    };
...
var CubicBezierCalculator = /** @class */ (function () {
    ...
    CubicBezierCalculator.prototype.bezierCalculator = function () {
        ...
        // i += 1/(samplePointNumber*sampleScale)
        // ){
        for (var i = 0 / (samplePointNumber * sampleScale); i < 1. + 0 / (samplePointNumber * sampleScale); i += 1 / (samplePointNumber * sampleScale)) {
