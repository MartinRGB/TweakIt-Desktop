import {FlutterLinear,FlutterDecelerate,FlutterElasticIn,FlutterElasticOut,FlutterElasticInOut,FlutterBounceIn,FlutterBounceOut,FlutterBounceInOut} from '@Components/Solver/Calculator/type/InterpolatorExtend'
