...
exports.CreateSolverByString = void 0;
...
//     }
// }
exports.CreateSolverByString = function (calculator, platform, name, data) {
    // console.log(calculator)
    // console.log(platform)
    // console.log(name)
    console.log(data);
    var mSolver = Solver_1["default"];
...
var trimEmptyStr = function (str) {
    return str.replace(/\s+/g, "");
};
var trimInterpolatorStr = function (str) {
