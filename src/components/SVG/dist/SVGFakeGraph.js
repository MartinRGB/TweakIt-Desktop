...
var SVGFakeGraph = function (_a) {
    ...
    var _b = react_1.useContext(AnimatorTypeContext_1.AnimatorTypeContext), currentAnimName = _b.currentAnimName, currentAnimCalculator = _b.currentAnimCalculator, currentSolverData = _b.currentSolverData, previousAnimName = _b.previousAnimName, previousAnimCalculator = _b.previousAnimCalculator, previousSolverData = _b.previousSolverData, selectTransition = _b.selectTransition, setSelectTransition = _b.setSelectTransition;
    ...
    var t = 0;
    if (selectTransition) {
        var prevStepData_1 = Solver_1["default"].CreateSolverByString(previousAnimCalculator, previousAnimName, previousSolverData).getStepArray();
        var prevValueData_1 = Solver_1["default"].CreateSolverByString(previousAnimCalculator, previousAnimName, previousSolverData).getValueArray();
        var animInterval = setInterval(function () {
            ...
            if (t >= currValueData.length) {
                ...
                mSVGData = SVGUtil_1.SVGTransitionTemplate_50(prevStepData_1, prevValueData_1, currStepData, currValueData, svgWidth, svgHeight, currValueData[t]);
