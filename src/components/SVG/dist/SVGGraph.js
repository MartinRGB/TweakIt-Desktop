...
var SVGGraph = function (_a) {
    ...
    var _b = react_1.useContext(AnimatorTypeContext_1.AnimatorTypeContext), selectTransition = _b.selectTransition, currentAnimName = _b.currentAnimName, currentAnimPlatform = _b.currentAnimPlatform, currentAnimCalculator = _b.currentAnimCalculator, currentSolverData = _b.currentSolverData;
    ...
    if (selectTransition) {
        ...
        mSVGData = SVGUtil_1.SVGTemplate_50(currStepData, currValueData, svgWidth, svgHeight, 1.);
    }
    // ############ Try Smooth Pathline ############
